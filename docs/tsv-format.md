...
| `pr_size_xs` | integer | Number of PRs sized `xs` in the interval for the user |
| `pr_size_s` | integer | Number of PRs sized `s` in the interval for the user |
| `pr_size_m` | integer | Number of PRs sized `m` in the interval for the user |

...
- `xs` : sizePoints <= SIZE_XS_THRESHOLD (default: 50)
- `s`  : SIZE_XS_THRESHOLD < sizePoints <= SIZE_S_THRESHOLD (default: 200)
- `m`  : SIZE_S_THRESHOLD < sizePoints <= SIZE_M_THRESHOLD (default: 400)
- `l`  : SIZE_M_THRESHOLD < sizePoints <= SIZE_L_THRESHOLD (default: 700)
- `xl` : sizePoints > SIZE_L_THRESHOLD

You can customize both the deletion weight and the size thresholds by setting the corresponding input parameters (see below).
...
| `PERIOD_SPLIT_UNIT`         | Allows for the additional display of reports with data broken down by years, quarters, months or weeks for the reporting period. This extra analysis will be added as comments in the issue. This breakdown can be removed by using the value `none`. Can take values: `years`, `quarters`, `months`, `week`, `none`                              | `months`                                                                |
...
| `SIZE_XS_THRESHOLD`         | Maximum sizePoints value for 'xs' PR size classification.                                                                                                                                                                                                                                                                                                                                             | `50`                                                                    |
| `SIZE_S_THRESHOLD`          | Maximum sizePoints value for 's' PR size classification.                                                                                                                                                                                                                                                                                                                                              | `200`                                                                   |
| `SIZE_M_THRESHOLD`          | Maximum sizePoints value for 'm' PR size classification.                                                                                                                                                                                                                                                                                                                                              | `400`                                                                   |
| `SIZE_L_THRESHOLD`          | Maximum sizePoints value for 'l' PR size classification. Values above this threshold are classified as 'xl'.                                                                                                                                                                                                                                                                                          | `700`                                                                   |
